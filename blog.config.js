...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '未知w', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢折腾后端技术的青年。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gaoxianlife.zeabur.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Go, 博客', // 网站关键词 英文逗号隔开
