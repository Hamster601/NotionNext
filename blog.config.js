...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '好吧，我也不知道怎么介绍了，总之，我就是一个喜欢折腾后端技术的吧。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notionblog-git-main-hamster601.vercel.app/', // 网站地址
